...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->Username = 'suresuccessquery@gmail.com';  // Use your SMTP username

        $mail->Password = 'pejdfhpipgnbtimf';  // Use your SMTP password
        ...
        //$mail->setFrom('suresuccessquery@gmail.com');

        $mail->addAddress('suresuccessquery@gmail.com', 'Sure Success');  
